...
<div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8" x-data="productForm()">
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div x-data="imageInput('image', 'upload', '', '')" class="space-y-3">
                ...
                <div x-show="mode === 'upload'" x-transition>
                    <div class="mb-2 w-20 h-20 bg-slate-50 border border-slate-200 rounded-xl flex items-center justify-center text-2xl overflow-hidden" x-show="preview">
